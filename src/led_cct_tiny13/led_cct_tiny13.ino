/*
CCTLed - A simple CCT Led strip driver with IR remote
Copyright (C) 2023 freeman401
Copyright (C) 2013 FastLED (scale8 routine)
Copyright (C) 2021 AlexGyver (NEC decoding routine)
